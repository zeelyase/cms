...
class contact extends CI_Controller
{
    ...
    public function imageDelete($id, $parent_id){
        ...
        $fileName = $this->contact_image_model->get(
            array(
                "id"    => $id
            )
        );

        $delete = $this->contact_image_model->delete(
            array(
                "id"    => $id
            )
        );
        ...
        if($delete){
            ...
            redirect(base_url("contact/image_form/$parent_id"));
        } else {
            redirect(base_url("contact/image_form/$parent_id"));
        }
    ...
    public function imageIsActiveSetter($id){
        ...
        if($id){
            ...
            $this->contact_image_model->update(
                array(
                    "id"    => $id
                ),
                array(
    ...
    public function isCoverSetter($id, $parent_id){
        ...
        if($id && $parent_id){
            ...
            $viewData->item_images = $this->contact_image_model->get_all(
                array(
                    "contact_id"    => $parent_id
                ), "rank ASC"
            );
